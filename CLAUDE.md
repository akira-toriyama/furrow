...
- Canonical commands: `furrow add|ls|show|next|revisit|board|edit|attach|done|move|set|reorder|retitle|value|effort|check|dep|label|repo|sync|apply|archive|lint|config|init`.
