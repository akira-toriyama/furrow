...
var lintCodes = map[string]bool{
	...
	"epic-closed":          true,
	"epic-dep-cycle":       true,
	"epic-dep-missing":     true,
	"epic-dep-open":        true,
	"epic-duplicate-id":    true,
	"epic-id-pattern":      true,
	"epic-missing":         true,
	"epic-multi-active":    true,
	"epic-no-active":       true,
	"epic-required":        true,
	"id-pattern":           true,
	"label-required":       true,
	...
	"provenance-missing":   true,
	"ready-blocked":        true,
	"reconcile-gap":        true,
	"repeat-invalid":       true,
	"repeat-no-timezone":   true,
	"repeat-on-closed":     true,
	"repeat-orphan-anchor": true,
	"repo-as-label":        true,
	"repo-shape":           true,
	"schema-outdated":      true,
	"shard-misnamed":       true,
	"stale-inbox":          true,
	"title-scope-marker":   true,
	"unknown-lane":         true,
