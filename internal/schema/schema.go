...
const EpicV2 = `{
  ...
  "properties": {
    ...
    "standing": { "type": "boolean", "description": "declares a PERMANENT box (an inbox-like channel, a parking lot): exempt from the finish-shaped revisit nags epic_all_done and epic_dep_done (epic_stuck still fires). furrow never interprets which boxes deserve it — that binding is the operator's convention." },
