# Canonical reference copy of the furrow Homebrew formula. The LIVE formula in
# akira-toriyama/homebrew-tap (Formula/furrow.rb) is REGENERATED by GoReleaser on
# each release (binary-based; see .goreleaser.yaml `brews:`), so this file is for
# reference and `brew install --HEAD` (from-source) use.
#
