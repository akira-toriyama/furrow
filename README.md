...
furrow is **non-interactive by default** — it never prompts. Destructive operations are guarded: `archive`, `rm`, `epic rm`, `tidy`, and `upgrade` only preview unless you pass `--yes`.
